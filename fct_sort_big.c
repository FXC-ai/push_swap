...
/*   Updated: 2023/02/03 14:53:43 by fcoindre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cor_al1(t_node **ptr_frst_a, t_node **ptr_first_b, int min, int max)
{
	...
	nb_rotate = ft_srch_from_top_a(ptr_frst_a, min, max);
	nb_rev_rotate = ft_srch_from_bottom_a(ptr_frst_a, min, max);
	if (nb_rotate != -1 && nb_rev_rotate != -1)
	{
		if (nb_rotate <= nb_rev_rotate)
		{
		...
		ft_push_b(ptr_frst_a, ptr_first_b);
	}
}
